...
vertices = [['upper_left_face_visible','upper_left_back_visible', 'upper_right_face_visible','lower_left_face_visible'],
...
for index, row in image_files.iterrows():
    ...
    img_vertices = cv2.putText(img_vertices, str(row[2])+" - " + str(i), org, font, fontScale, color, thickness, cv2.LINE_AA)
